 ...
 * Use:	Place CheckInput class in the same project folder as 
 * your code.
		...
		while( !valid ) {
			if( in.hasNextInt() ) {
				...
				if( input <= high && input >= low ) {
					...
					System.out.println("Please enter a valid number from the choices given." );
				}
			} else {
				in.next(); //clear invalid string
				System.out.println( "Please enter a valid number from the choice given." ); 
			}
		}
		return input;
	}
